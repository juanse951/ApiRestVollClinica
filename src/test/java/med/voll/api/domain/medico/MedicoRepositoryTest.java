...
@DataJpaTest //es para testeo de repository
...
class MedicoRepositoryTest {
    ...
    void elegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        var paciente = registrarPaciente("Paciente1", "paciente@gmail.com","654321");
        registrarConsulta(medico,paciente,lunesSiguienteALas10);
        //when o act --> Cuando ,ejecuto un metodo necesario
